...
{% blockquote https://zh.wikipedia.org/wiki/C4.5%E7%AE%97%E6%B3%95 香农熵 %}
...
而汉字常用的有2500个，假如每个[汉字](https://zh.wikipedia.org/wiki/%E6%B1%89%E5%AD%97)在文章中出现次数平均的话，每个汉字的信息量为：
...
${\displaystyle I_{G}(f)=1-\sum _{i=1}^{m}{f_{i}}^{2}}$
